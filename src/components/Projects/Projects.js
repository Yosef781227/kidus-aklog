          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              The inspiration for the design came from their original shirt from the first time they wore it.
               Ethiopian Coffee S.C. has over 1 million funs in Ethiopia, and the funs loved all of the designs and fought to have them."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              football team. What makes it interesting is that it is the first time in Ethiopia for clubs to have their own hoodie,
               and I was extremely thrilled to be a part of that initiative, which has had a positive response from the fun base."
