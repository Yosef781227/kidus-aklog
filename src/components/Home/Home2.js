        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
             ...
             With my powerful design skills and knack  <br/>for marketing, I have the right background for your brand's needs.
             While software development and graphic design are my two passions, I also enjoy &nbsp;
              
              
              <i>
                <b className="purple">Coding, &nbsp; Cinematography, &nbsp;exploring the world  and Football.&nbsp;
                 </b>
              </i>
